...
% \setCJKmainfont{Source Han Sans CN}  % 思源黑体
% \setCJKmainfont{Source Han Sans HW SC}  % 思源黑体等宽
% \setCJKmainfont[BoldFont=SimHei,ItalicFont=KaiTi]{SimSun}  % 宋体
...
% 生成 contents 与 title (in document)
%%% Roman(大写罗马数字), roman(小写罗马数字), arabic(数字), Alph(大写字母), alph(小写字母), fnsymbol(符号)
...
% 文献数据库
% \bibliography{}  % 待加入的数据库
% 文献格式
% | 格式  | 字母编号 | 条目排序 | 排序方式         | 缩写人名 | 月份全称 | 期刊全称 |
% | plain | NO       | YES      | 作者、日期、标题 | NO       | YES      | YES      |
% | unsrt | NO       | NO       |                  | NO       | YES      | YES      |
% | alpha | YES      | YES      | 作者             | NO       | YES      | YES      |
% | abbrv | NO       | YES      | 作者、日期、标题 | YES      | NO       | NO       |
